...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    :param image:       [H, W, C]
    :param boxes:       [N, (y1, x1, y2, x2)] in image coordinates.
    :param masks:       [H, W, N] instance binary masks
    :param class_ids:   [N] int class IDs
    :param class_names: list of class names of the dataset
    :param scores:      (optional) [N] float probability scores for the class IDs
    :param title:       (optional) Figure title
    :param figsize:     (optional) the size of the image
    :param ax:
    :param show_mask:   Boolean
    :param show_bbox:   Boolean
