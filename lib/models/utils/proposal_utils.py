...
def apply_box_deltas_graph(boxes, deltas):
    ...
    :return: [N, (y1, x1, y2, x2)] decoded result
    '''
...
class ProposalLayer(KE.Layer):
    ...
    def call(self, inputs):
        ...
        :param inputs: [rpn_class, rpn_bbox, anchors]
            rpn_class: [batch, N, 2] Anchor classifier probabilities.
            rpn_bbox: [batch, N, (dy, dx, log(dh), log(dw))] Deltas to be
                        applied to anchors.
            anchors: [batch, N, (y1, x1, y2, x2)] in normalized coordinates
        :return: [batch, self.proposal_count, (y1, x1, y2, x2)] in normalized coordinates
        '''
