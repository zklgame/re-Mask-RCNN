...
from lib.models.utils.box_utils import norm_boxes_graph
from lib.models.utils.batch_slice_utils import batch_slice
from lib.models.utils.proposal_utils import apply_box_deltas_graph, clip_boxes_graph
...
class DetectionLayer(KE.Layer):
    ...
    def call(self, inputs):
        ...
        :param inputs: [rpn_rois, mrcnn_class, mrcnn_bbox, input_image_meta]
                rois:               [batch, num_rois, (y1, x1, y2, x2)] in normalized coordinates
                ...
                image_meta:         [batch, config.IMAGE_META_SIZE]
        :return: [batch, num_detections, (y1, x1, y2, x2, class_id, class_score)] where coordinates are normalized.
        '''
